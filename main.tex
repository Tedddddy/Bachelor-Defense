...
\begin{frame}
  ...
  \begin{itemize}
      \item Reasoning in one dimension via horizontal and vertical relations \pause% , for example we a fix time point and ask what does the agent knows at that time?
    \end{itemize}   
    \begin{definition}
