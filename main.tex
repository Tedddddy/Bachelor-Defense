...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item combine temporal and epistemic logic to reason about "when does the agent knows something" \pause % consider the product of frames to interpret the formulas 
    \item Product of frames: horizontal and vertical relation allows us to reason in one dimension \pause% , for example we a fix time point and ask what does the agent knows at that time?
    \begin{definition}
